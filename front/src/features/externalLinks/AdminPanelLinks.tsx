  ...
  return (
    <div className="relative inline-block text-left" ref={menuRef}>
      <a
        href="#"
        onClick={handleClick}
        className="glass-panel menu-dots-icon flex items-center justify-center w-10 h-10 cursor-pointer transition-transform active:scale-95 no-underline box-border text-center"
        role="button"
