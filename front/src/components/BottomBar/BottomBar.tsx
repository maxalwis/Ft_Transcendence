...
export default function BottomBar()
{
	...
	<div className="fixed bottom-2 w-full flex flex-row items-center justify-between px-6 py-3 z-500">
		...
		<button
			className="glassmorphism-popup flex items-center justify-center h-10 w-10 cursor-pointer hover:zoom-98">
			<img
				src="https://img.icons8.com/?size=25&id=eMfeVHKyTnkc&format=png&color=000000">
			</img>
		</button>
		</div>
	</div>
