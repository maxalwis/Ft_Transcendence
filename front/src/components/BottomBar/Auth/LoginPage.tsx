...
export default function LoginPage()
{
	...
	const handleGoogleLogin = () => {
		window.location.href = "https://accounts.google.com/o/oauth2/auth?client_id=513700796427-64gvloa5ugr6ugebfne104u5v44u1en7.apps.googleusercontent.com&redirect_uri=https://localhost:8443&response_type=code&scope=email%20profile";
	};
		...
		<div className='border-2 p-10 rounded-sm border-orange-500 bg-white'>
			...
			<div className='flex items-center justify-center gap-2'>
				...
				<button
					...
					<img
						src='https://cdn.simpleicons.org/42?viewbox=auto&size=20'>
					</img>
				</button>
				<button
