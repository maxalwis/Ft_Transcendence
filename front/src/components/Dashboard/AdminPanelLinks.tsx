...
const dashboards: DashboardLink[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
  ...
  return (
    <div className="relative inline-block text-left" ref={menuRef}>
      <button
        ...
        style={{ border: '1px solid rgba(255, 103, 18, 0.3)' }}
        className="glassmorphism-element w-10 h-10 rounded-xl cursor-pointer transition-transform active:scale-95 flex items-center justify-center shadow-md"
      ...
      {isOpen && (
        <div className="glassmorphism-popup absolute left-0 mt-2 w-64 z-50 p-3">
...
export const AdminPanelLinks: React.FC = () => {
  useEffect(() => {
    ...
    // Prevent map click events from triggering when clicking inside our menu
    L.DomEvent.disableClickPropagation(controlDiv);
    L.DomEvent.disableScrollPropagation(controlDiv);

    // Render the React component into the control div
