...
var IngestionController = function () {
    var _classDecorators = [(0, common_1.Controller)('ingestion')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _trigger_decorators;
    var IngestionController = _classThis = /** @class */ (function () {
        function IngestionController_1(ingestionService) {
            this.ingestionService = (__runInitializers(this, _instanceExtraInitializers), ingestionService);
        }
        IngestionController_1.prototype.trigger = function () {
            return this.ingestionService.fetchFromMairieParis();
        };
        return IngestionController_1;
    }());
    __setFunctionName(_classThis, "IngestionController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _trigger_decorators = [(0, common_1.Post)('mairie-paris')];
