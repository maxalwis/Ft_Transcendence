...
var EventsController = function () {
    ...
    var EventsController = _classThis = /** @class */ (function () {
        function EventsController_1(eventsService) {
            ...
            this.logger = new common_1.Logger(EventsController.name);
        }
        EventsController_1.prototype.findForMap = function (query) {
            this.logger.log("GET /events/map - BBox: [".concat(query.bbox.minLon.toFixed(4), ", ").concat(query.bbox.minLat.toFixed(4), ", ").concat(query.bbox.maxLon.toFixed(4), ", ").concat(query.bbox.maxLat.toFixed(4), "]") +
                (query.from ? " - from: ".concat(query.from) : '') +
                (query.to ? " - to: ".concat(query.to) : ''));
            return this.eventsService.findForMap(query.bbox, query.from, query.to);
        };
        EventsController_1.prototype.findNearby = function (query) {
            return this.eventsService.findNearby(query, query.from, query.to);
        };
        EventsController_1.prototype.findOne = function (id) {
    ...
    (function () {
        ...
        _findForMap_decorators = [(0, common_1.Get)('map')];
        _findNearby_decorators = [(0, common_1.Get)('nearby')];
        _findOne_decorators = [(0, common_1.Get)(':id')];
        __esDecorate(_classThis, null, _findForMap_decorators, { kind: "method", name: "findForMap", static: false, private: false, access: { has: function (obj) { return "findForMap" in obj; }, get: function (obj) { return obj.findForMap; } }, metadata: _metadata }, null, _instanceExtraInitializers);
