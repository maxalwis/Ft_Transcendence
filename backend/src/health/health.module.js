...
var prisma_health_1 = require("../prisma/prisma.health");
var HealthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [terminus_1.TerminusModule, prisma_module_1.PrismaModule],
            controllers: [health_controller_1.HealthController],
            providers: [prisma_health_1.PrismaHealthIndicator], // <-- Ajouté ici
        })];
    ...
    var HealthModule = _classThis = /** @class */ (function () {
        ...
        HealthModule_1.prototype.configure = function (consumer) {
