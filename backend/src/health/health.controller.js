...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(health, prismaHealth) {
        ...
        HealthController_1.prototype.readiness = function () {
            ...
            return this.health.check([
                function () { return _this.prismaHealth.isHealthy('database'); },
            ]);
        };
    ...
    (function () {
        ...
        _readiness_decorators = [(0, common_1.Get)(), (0, terminus_1.HealthCheck)()];
