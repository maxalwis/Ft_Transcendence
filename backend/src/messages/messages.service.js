...
var MessagesService = function () {
    ...
    var MessagesService = _classThis = /** @class */ (function () {
        ...
        MessagesService_1.prototype.create = function (createMessageDto) {
            return __awaiter(this, void 0, void 0, function () {
                var content, userId, eventId, user, event;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            content = createMessageDto.content, userId = createMessageDto.userId, eventId = createMessageDto.eventId;
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.event.findUnique({ where: { id: eventId } })];
                        case 2:
                            event = _a.sent();
                            if (!event) {
                                throw new common_1.NotFoundException("Event with ID ".concat(eventId, " not found"));
                            }
        ...
        MessagesService_1.prototype.findByEvent = function (eventId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
