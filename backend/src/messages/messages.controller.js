...
var MessagesController = function () {
    ...
    var MessagesController = _classThis = /** @class */ (function () {
        ...
        MessagesController_1.prototype.create = function (id, createMessageDto) {
            createMessageDto.eventId = id;
            return this.messagesService.create(createMessageDto);
        };
        MessagesController_1.prototype.findByEvent = function (id) {
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(':id/messages')];
        _findByEvent_decorators = [(0, common_1.Get)(':id/messages')];
